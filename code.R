...
#Import data
setwd("C:/Users/LENOVO T46OS/Desktop/C:/Users/LENOVO T46OS/Desktop/sdc-bgd-mcna")
data <- read_excel("data.xlsx", sheet = "Dataset - Household", 
...
selectedKeyVars <- c('respondent_age',	'respondent_gender',
                     'respondent_hoh',	'hoh_gender',
                     'hoh_age',	'hoh_marital',	'hh_size',
                     'edu_highest', 'language', 'disability_support',
                     'income_source', 'Upazila'
)
...
cols =  c('respondent_age',	'respondent_gender',
          'respondent_hoh',	'hoh_gender',
          'hoh_age',	'hoh_marital',	'hh_size',
          'edu_highest', 'language', 'disability_support',
          'income_source', 'Upazila')
